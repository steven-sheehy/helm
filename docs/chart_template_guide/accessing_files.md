...
* [Basic example](accessing_files.md#basic-example)
* [Path helpers](accessing_files.md#path-helpers)
* [Glob patterns](accessing_files.md#glob-patterns)
* [ConfigMap and Secrets utility functions](accessing_files.md#configmap-and-secrets-utility-functions)
* [Encoding](accessing_files.md#encoding)
* [Lines](accessing_files.md#lines)
...
Given the directory structure from the [Glob](accessing_files.md#glob-patterns) example above:
