...
This command uninstalls Tiller \(the Helm server-side component\) from your Kubernetes Cluster and optionally deletes local configuration in $HELM\_HOME \(default ~/.helm/\)
